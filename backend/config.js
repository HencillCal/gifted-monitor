...
module.exports = {
  ...
  RESEND1_DOMAIN:  process.env.RESEND1_DOMAIN  || "monitor-alerts.giftedtech.co.ke",
  RESEND2_API_KEY: process.env.RESEND2_API_KEY || "",
  RESEND2_DOMAIN:  process.env.RESEND2_DOMAIN  || "monitoring-alerts.giftedtech.co.ke",
  RESEND3_API_KEY: process.env.RESEND3_API_KEY || "",
  RESEND3_DOMAIN:  process.env.RESEND3_DOMAIN  || "monitoring-alert.giftedtech.co.ke",
  ...
  FRONTEND_URL: process.env.FRONTEND_URL || "https://monitor.giftedtech.co.ke",
